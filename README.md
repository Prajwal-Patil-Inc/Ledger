...
A central overview of your financial position.
...
<table>
  <tr>
    <td align="center">
      <img src="screenshots/Expenses-tab.png" width="90%" alt="Expenses tab">
      <br>
      Expenses tab
    </td>
    <td align="center">
      <img src="screenshots/Add-expenses.png" width="90%" alt="Add Expenses">
      <br>
      Add expenses
    </td>
  </tr>
...
The application is built as a Progressive Web App, giving it the convenience of a web application with the experience of an installable app.

You can use it from a browser and, on supported devices, install it directly to your device for quick access.
...
Add any applicable due-date, paid, or recurring information.
Save the expense.

The new expense is then reflected throughout the application automatically.
...
The What-If calculator allows you to experiment with changes to your finances without having to alter your actual financial data.
...
It provides a quick way to understand how financial decisions could affect your overall position.
...
The thresholds can be customized from Settings.

📈 Automatic Insights

The dashboard doesn't just display numbers — it turns them into useful information.

Insights are generated from the user's financial data to highlight things such as:
...
The goal is to make the application useful even for users who don't want to spend time analyzing spreadsheets or raw financial data.
...
The application is designed so that users primarily enter financial data, while the application handles the calculations.
...
This keeps the experience focused on managing finances rather than maintaining calculations.
...
Do not use the application as a replacement for professional financial advice.
